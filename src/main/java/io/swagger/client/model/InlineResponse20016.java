...
public class InlineResponse20016   {
  ...
  public InlineResponse20016 status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20016 data(List<Segment> data) {
    this.data = data;
    return this;
  }

  public InlineResponse20016 addDataItem(Segment dataItem) {
